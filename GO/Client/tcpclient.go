...
func Handler(conn net.Conn, fileName string) {
	buf := make([]byte, 2048)
	...
	resfileSizeStr := string(buf[:n])
	resfileSize, _ := strconv.Atoi(resfileSizeStr)
